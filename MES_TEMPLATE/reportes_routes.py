...
<div class="section">
  ...
  <div class="obs-grid">
    ...
    # TODO: Reemplazar nombres, cargos y archivos de firma según el cliente.
    # Los archivos de firma deben colocarse en la carpeta 'Firmas empleados'.
    firma_html = f"""
<div class="firma-row">
  <div class="firma-box">
    <img src="/firma-supervisor/firma_jefe_produccion.png" alt="Firma Jefe de Producción" style="height:50px;object-fit:contain;margin-bottom:8px;">
    <div class="firma-line"></div>
    <div class="firma-cargo">Jefe de Producción</div>
    <div class="firma-nombre">Nombre Jefe Producción</div>
  </div>
  <div class="firma-box">
    <img src="/firma-supervisor/firma_responsable_tecnico.png" alt="Firma Responsable Técnico" style="height:50px;object-fit:contain;margin-bottom:8px;">
    <div class="firma-line"></div>
    <div class="firma-cargo">Ing. Responsable</div>
    <div class="firma-nombre">Nombre Responsable Técnico</div>
  </div>
</div>"""
