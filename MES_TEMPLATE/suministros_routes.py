...
# TODO: Reemplazar con nombres reales de supervisores del cliente
SUPERVISORES = ["Supervisor 1", "Supervisor 2"]

# TODO: Cargar lista de proveedores habituales del cliente (puede quedar vacía e ingresarse manualmente)
PROVEEDORES_EXCEL = []
...
def op_nueva():
    ...
    # Lista de solicitantes (supervisores activos)
    supervisores = db.execute(
        "SELECT nombre FROM usuarios WHERE rol='supervisor' AND activo=1 ORDER BY nombre"
    ).fetchall()
