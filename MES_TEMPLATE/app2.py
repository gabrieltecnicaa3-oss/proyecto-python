...
# ─────────────────────────────────────────────────────────────
# USUARIOS INICIALES — Personalizar para cada cliente.
# Formato: (username, password_temporal, nombre_completo, rol, activo)
# Roles disponibles: ROLE_ADMIN, ROLE_SUPERVISOR, ROLE_OBRA
# ─────────────────────────────────────────────────────────────
USUARIOS_INICIALES = [
    # Administrador principal — CAMBIAR contraseña después del primer login
    ("admin", "admin1234", "Administrador", ROLE_ADMIN, 1),
    # Ejemplo supervisor — reemplazar con datos reales del cliente
    ("supervisor1", "temp1234", "Supervisor Ejemplo", ROLE_SUPERVISOR, 1),
    # Ejemplo operario de obra
    ("operario1", "temp1234", "Operario Ejemplo", ROLE_OBRA, 1),
]
...
# ─────────────────────────────────────────────────────────────
# INSPECTOR DE CALIDAD — Personalizar con el nombre del inspector
# responsable de las aprobaciones finales (firma OK).
# ─────────────────────────────────────────────────────────────
FIRMA_OK_AUTOMATICA = "INSPECTOR CALIDAD"  # TODO: reemplazar con nombre real
FIRMA_OK_CANDIDATOS = [
    "FIRMA_OK.png",
    "FIRMA_OK.jpg",
    "FIRMA_INSPECTOR.png",
...
# Mapa: nombre_display -> texto_firma (debe coincidir con 'nombre' en empleados_parte)
INSPECTOR_FIRMAS = {
    # "Juan Pérez": "JUAN PEREZ",   # Ejemplo — agregar inspectores reales del cliente
}
