...
def _build_pdf_bytes(auditoria, observaciones, evaluaciones=None):
    ...
    # ── FIRMAS ───────────────────────────────────────────────────────────
    # TODO: Reemplazar nombre de archivo con la firma real del coordinador del cliente
    _FIRMA_COORDINADOR_ARCHIVO = "firma_coordinador.png"  # colocar en carpeta 'Firmas empleados'
    _FIRMA_COORDINADOR_NOMBRE = "Coordinador EEMM"        # TODO: nombre real
    firma_coord_path = ""
    for candidate in (
      os.path.join(os.path.dirname(os.path.abspath(__file__)), "Firmas empleados", _FIRMA_COORDINADOR_ARCHIVO),
      os.path.join(os.path.dirname(os.path.abspath(__file__)), "Firmas empleados", "firma_coordinador.jpg"),
    ):
    ...
    if firma_coord_path:
      try:
        ...
        firma_coord_flowable = Paragraph(_FIRMA_COORDINADOR_NOMBRE, st_normal)
